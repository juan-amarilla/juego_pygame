...
import pygame
from constantes_inicio import TIPO_FUENTE, COLORES, PANTALLA, OPCIONES, VERTICAL, POSICION
...
def colocar_texto(texto: str, x: int, y: int) -> None:
    ...
    PANTALLA.blit(resultado, (x - resultado.get_width() //
                  2, y - resultado.get_height() // 2))
